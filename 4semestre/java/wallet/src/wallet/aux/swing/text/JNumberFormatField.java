...
public class JNumberFormatField extends JTextField
{
    ...
    public JNumberFormatField(NumberFormat format)
    {
        ...
        setDocument(new PlainDocument() {
            ...
            {
                String text = new StringBuilder(JNumberFormatField.this.getText()
                    .replaceAll("[^0-9]", ""))
                ...
                super.insertString(0, numberFormat.format(
                            new BigDecimal(getLimit() > 0 && text.length() > getLimit() ? text
    ...
    */
    public final BigDecimal getValue()
    {
        return new BigDecimal(getText().replaceAll("[^0-9]", ""))
                .divide(new BigDecimal(Math.pow(10, numberFormat
    ...
    */
    ...
    /**
    * Define o limite do campo, limit < 0 para deixar livre (default).
    * Ignora os pontos e virgulas do formato, conta
